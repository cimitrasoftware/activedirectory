# List users whose account is set to expired
...
Write-Output ""
Write-Output "Following is a list of all users whose accounts are expired."
Write-Output ""
Write-Output "-------------------------------------------------------------"
...
{ 
try{
Search-ADAccount -SearchBase $contextIn -AccountExpired -UsersOnly |  Select-Object Name, SamAccountName, DistinguishedName, AccountExpirationDate | fl
