# List Active Directory Users with an expire date
...
{ 
try{
Get-Aduser -SearchBase $contextIn -Filter "AccountExpirationDate -ne '*'" -Properties AccountExpirationDate | select Name, AccountExpirationDate | fl
