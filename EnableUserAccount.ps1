# Enable a User's Account in Active Directory
...
Write-Host ""
Write-Host "Enable a User's Active Directory Account"
Write-Host ""
Write-Host "[ HELP ]"
Write-Host ""
...
try{
Enable-ADAccount -Identity "CN=${firstNameIn} ${lastNameIn},$context"  
 }catch{
 ...
 Write-Output "------------------------------------------------------------------------------"
 Write-Output ""
 Write-Output "Account Enabled for User: ${firstNameIn} ${LastNameIn}"
 Write-Output ""
 Write-Output "------------------------------------------------------------------------------"
 }else{
 Write-Output ""
 Write-Output "Account for User: ${firstNameIn} ${LastNameIn} NOT Enabled"
Write-Output ""
    if ($verboseOutputSet){
