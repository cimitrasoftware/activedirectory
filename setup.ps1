...
Write-Output "Invoke-RestMethod -Uri $uri/agent/$cimitraAgentId -Method GET -Headers $headers -UseBasicParsing"
}

try{
Invoke-RestMethod -Uri $uri/agent/$cimitraAgentId -Method GET -Headers $headers -UseBasicParsing | fl > $TEMP_FILE_ONE
}
catch{
Remove-Item -Path $TEMP_FILE_ONE -Force 2>&1 | out-null
