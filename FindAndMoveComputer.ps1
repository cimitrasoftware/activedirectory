...
# Authors: Jennifer Stuller @ Tiffin University, Tay Kratzer tay@cimitra.com
# Date: 12/17/20
# -------------------------------------------------

# Testing Examples

# .\FindAndMoveComputer.ps1 -showErrors -ComputerNameIn "WIN-COMPUTER-ONE" -NewContextIn "OU=STUDENTS,OU=DEMOCOMPUTERS,DC=cimitrademo,DC=local"

# .\FindAndMoveComputer.ps1.ps1 -showErrors -ComputerNameIn "WIN-COMPUTER-ONE" -NewContextIn "OU=IT_DEPARTMENT,OU=DEMOCOMPUTERS,DC=cimitrademo,DC=local"
