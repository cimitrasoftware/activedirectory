...
Write-Host ""
Write-Host ".\$scriptName -FirstNameIn <user first name> -FastNameIn <user last name> -MobilePhoneIn <mobile number> -contextIn <Active Directory context (optional if specified in settings.cfg)>"
Write-Host ""
Write-Host "-OR-"
Write-Host ""
Write-Host ".\$scriptName -FirstNameIn <user first name> -LastNameIn <user last name> -MobilePhoneIn <mobile number> "
Write-Host ""
Write-Host "[ EXAMPLES ]"
Write-Host ""
...
# Modify the user
try{
Set-ADUser -Identity "CN=${firstNameIn} ${lastNameIn},$contextIn" -MobilePhone "$mobilePhoneIn"
}catch{
