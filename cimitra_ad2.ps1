...
### Remove the first and last characters in a string and assing the value to an Integer ###
...
if(!($UpdateActiveDirectoryObject -or $AddToActiveDirectory -or $AddToExchange))
{
$GetUserInfo = $true
}
...
$CimitraAgentLognAccountInEmpty = [string]::IsNullOrWhiteSpace($CimitraAgentLogonAccountInEmpty)
if($CimitraAgentLogonAccountInEmptympty){
Write-Output ""
