...
try{
Clear-ADAccountExpiration -Identity "CN=${firstNameIn} ${lastNameIn},$context"
 }catch{
 ...
 Write-Output "------------------------------------------------------------------------------"
 Write-Output ""
 Write-Output "Account Expiration Removed for User: ${firstNameIn} ${LastNameIn}"
 Write-Output ""
 Write-Output "------------------------------------------------------------------------------"
 }else{
 Write-Output ""
 Write-Output "Account Expire for User: ${firstNameIn} ${LastNameIn} NOT Removed"
Write-Output ""
    if ($verboseOutputSet){
